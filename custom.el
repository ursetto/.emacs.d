...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elpy pydoc flycheck undo-tree indent-tools hydra ace-window use-package avy esup cargo company-quickhelp company company-ghci merlin auto-complete tuareg utop smex rust-mode org magit ido-ubiquitous idle-highlight-mode haskell-mode erlang csv-mode ahg)))
