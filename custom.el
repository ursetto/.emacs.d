...
(custom-set-faces
 ...
 '(avy-lead-face ((t (:background "#af0000" :foreground "white"))))
 '(avy-lead-face-0 ((t (:background "#e52b50" :foreground "white"))))
 '(avy-lead-face-1 ((t (:background "#585858" :foreground "white"))))
 '(avy-lead-face-2 ((t (:background "#af00af" :foreground "white"))))
 ...
 '(error ((t (:background "#870000" :foreground "white" :weight bold))))
 '(font-lock-builtin-face ((t (:foreground "#ffaf5f"))))
 '(font-lock-constant-face ((t (:foreground "#ff875f"))))
 '(font-lock-doc-face ((t (:foreground "#af87af"))))
 '(font-lock-keyword-face ((t (:foreground "#ffd75f"))))
 '(font-lock-preprocessor-face ((t (:inherit font-lock-builtin-face))))
 '(font-lock-string-face ((t (:foreground "#87ffaf"))))
 '(font-lock-type-face ((t (:foreground "#afafff"))))
 '(font-lock-variable-name-face ((t (:foreground "#afd7ff" :underline nil))))
 ...
 '(magit-hash ((t (:foreground "#afafd7"))))
 ...
 '(rust-question-mark-face ((t (:inherit font-lock-builtin-face :foreground "#ff87af" :weight bold))))
 ...
 '(tuareg-font-lock-constructor-face ((t (:foreground "#ff8700"))))
