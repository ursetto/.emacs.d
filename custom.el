...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (gnu-elpa-keyring-update company-lsp lsp-mode yaml-mode pydoc flycheck undo-tree indent-tools hydra ace-window use-package avy esup cargo company-quickhelp company company-ghci merlin auto-complete tuareg utop smex rust-mode org magit ido-ubiquitous idle-highlight-mode haskell-mode erlang csv-mode ahg)))
...
(custom-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "color-219"))))
